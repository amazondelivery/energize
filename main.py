...
class Game:
    ...
    def click(self, coords, primary):
        #primary is True if the primary mouse button is clicked, False if secondary
        #coords should be a tuple for where the mouse is hovering
        return 0
